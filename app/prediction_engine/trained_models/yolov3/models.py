...
from app.prediction_engine.trained_models.yolov3.utils.google_utils import *
from app.prediction_engine.trained_models.yolov3.utils.parse_config import *
...
def attempt_download(weights):
    ...
    print("does model exists? : {0}".format(os.path.exists(weights)))
