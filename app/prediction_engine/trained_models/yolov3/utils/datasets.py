...
from app.prediction_engine.trained_models.yolov3.utils.utils import xyxy2xywh, xywh2xyxy
...
class LoadImages:  # for inference
    def __init__(self, path, image, img_size=416, half=False, load_from_file=True):
        ...
        if not load_from_file:
            ...
            assert self.image is not None, 'Image Not Found ' + path
