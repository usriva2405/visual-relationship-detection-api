...
class Encoders:
    ...
    # encoders for labels
    __label_encoder_location = Config.get_config_val(key="trained_models", key_1depth="is_relations",
                                                     key_2depth="encoders", key_3depth="encoder_location")
    __label_encoder_model_filename = Config.get_config_val(key="trained_models", key_1depth="is_relations",
    ...
    # encoders for is relationships
    __relation_encoder_model_filename = Config.get_config_val(key="trained_models", key_1depth="is_relations",
                                                              key_2depth="encoders", key_3depth="attribute_encoder")
